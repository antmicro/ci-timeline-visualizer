    ...
    static runnerEpoch() {
        if(TimeManager.runnerTimeOffset == null) {
            ...
            if(TimeManager.firstSection == null) {
                console.log("[ci-timeline-visualizer] You want to get an epoch while there is no 'prepare_executor' section while in 'distrustRunnerTime' mode. \n" +
        ...
        return TimeManager.localEpoch() + TimeManager.runnerTimeOffset;
    }
